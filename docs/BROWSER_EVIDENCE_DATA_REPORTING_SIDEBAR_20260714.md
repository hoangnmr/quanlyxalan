...
| **5.2. Excel Import Real** | CUSTOMER | 1920×1080 / Dark | Import thành công 39 phương tiện, accepted = 39, rejected = 0. | Import thành công hoàn toàn. | **PASS** | [customer_1920x1080_import_success.png](file:///D:/UNG%20DUNG%20AI/TOOL%20AI%202026/CVF-Workspace/Khai-bao-Cang-vu-recovery-ux/docs/evidence/data-reporting-sidebar-20260714/customer_1920x1080_import_success.png) | API POST /api/vessels/import: 200 OK. |
| **5.3. Import Idempotency** | CUSTOMER | 1920×1080 / Dark | Re-import lần 2 không tạo bản ghi trùng (accepted = 0). | Nhận diện trùng khóa và bỏ qua (idempotent). | **PASS** | [customer_1920x1080_import_idempotency.png](file:///D:/UNG%20DUNG%20AI/TOOL%20AI%202026/CVF-Workspace/Khai-bao-Cang-vu-recovery-ux/docs/evidence/data-reporting-sidebar-20260714/customer_1920x1080_import_idempotency.png) | Accepted = 0. |
...
- **Assets version:** App shell và các static assets được load với query parameter `?v=1.1.0` sạch sẽ, không bị cache cũ.

---

## 4. Kết luận Đóng Tranche (Gate 5)
> [!IMPORTANT]
> **TRANCHE STATUS: CLOSED (PASS)**
> 
> Toàn bộ 21 trường hợp kiểm thử UAT bắt buộc đối với Data, Reporting và Sidebar đã được kiểm nghiệm thực tế trên trình duyệt Chromium thật và lưu trữ ảnh chụp bằng chứng đầy đủ. Không phát hiện lỗi nghiêm trọng. Tranche này chính thức chuyển sang trạng thái **CLOSED/PASS**.
