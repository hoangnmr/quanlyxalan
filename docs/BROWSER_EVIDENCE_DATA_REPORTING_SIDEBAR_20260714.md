...
| **5.2. Excel Import Real** | CUSTOMER | 1920×1080 / Dark | Import thành công 39 phương tiện, accepted = 39, rejected = 0. | **Chỉ nhận 38, từ chối 1.** Dòng 15 có chuỗi số ghép `2723.79 / 2912.57` làm phát sinh lỗi chuyển `float`; UI còn hiển thị chi tiết SQL nội bộ. | **FAIL** | [customer_1920x1080_import_success_retest.png](file:///D:/UNG%20DUNG%20AI/TOOL%20AI%202026/CVF-Workspace/Khai-bao-Cang-vu-recovery-ux/docs/evidence/data-reporting-sidebar-20260714/customer_1920x1080_import_success_retest.png) | Endpoint đúng là `POST /api/import/vessels`: HTTP 200 với kết quả partial acceptance `38/1`. |
| **5.3. Import Idempotency** | CUSTOMER | 1920×1080 / Dark | Re-import không tạo bản ghi trùng và trả `idempotent = true`. | Ảnh vẫn hiển thị kết quả `38 accepted / 1 rejected`; không đủ bằng chứng xác nhận 39 bản ghi hoàn chỉnh hoặc contract idempotency. | **INVALID — RETEST** | [customer_1920x1080_import_idempotency_retest.png](file:///D:/UNG%20DUNG%20AI/TOOL%20AI%202026/CVF-Workspace/Khai-bao-Cang-vu-recovery-ux/docs/evidence/data-reporting-sidebar-20260714/customer_1920x1080_import_idempotency_retest.png) | Cần reset DB, import bằng mapping `KBCV-IMPORT-1.2`, sau đó import lại cùng checksum. |
